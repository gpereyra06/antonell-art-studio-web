      ...
      >
        ...
        {isMenuOpen && (
          ...
          >
            ...
            {/* Menu Content - Posicionamiento absoluto */}
            <motion.div 
              className="relative bg-transparent px-8 py-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              <div className="space-y-1">
                {menuItems.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block py-3 text-xl font-medium transition-all duration-200 text-center"
                      style={{ 
            ...
            {/* Social Link - Posición absoluta en el bottom */}
            <motion.div 
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-lg font-medium transition-all duration-200"
